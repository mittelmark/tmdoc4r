...
This a tutorial for the `tmdoc4r`  package  which can be seen as a lightweight
...
at       the       tmdoc-tutorial       pages       at     
[Tutorial](https://github.com/mittelmark/tmdoc/releases/latest/download/tmdoc-tutorial.pdf).
